...
import { GetBannerQuery } from '~/models/requests/Banner.request'

const bannerController = {
  getAll: async (req: Request<ParamsDictionary, any, any, GetBannerQuery>, res: Response, next: NextFunction) => {
