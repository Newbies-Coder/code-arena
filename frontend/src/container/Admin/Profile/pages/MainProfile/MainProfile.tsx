...
export default function MainProfile() {
  return (
    <div className="main-profile relative">
      ...
      <div className="flex flex-col items-center w-full h-full sm:flex-row p-4">
        <div className="w-full md:justify-center md:w-2/5 md:flex md:flex-col md:items-center">
        ...
        <div className="w-full md:w-3/5">
          <Form name="basic" initialValues={{ remember: true }} className="w-full flex flex-col items-center relative">
            ...
            <h3 className="absolute top-[84px] left-3 px-2 mb-0 text-white bg-black z-10 rounded-md">Username</h3>
            <Form.Item
              name="username"
              rules={[
                {
            ...
            <h3 className="absolute top-44 left-3 px-2 mb-0 text-white bg-black z-10 rounded-md">Phone number</h3>
            <Form.Item
              name="phone"
              rules={[
                {
            ...
            <h3 className="absolute top-[270px] left-3 px-2 mb-0 text-white bg-black z-10 rounded-md">Password</h3>
            <Form.Item
              name="password"
              rules={[
                {
            ...
            <h3 className="absolute top-[364px] left-3 px-2 mb-0 text-white bg-black z-10 rounded-md">Email</h3>
            <Form.Item
              name="email"
              rules={[
                {
            ...
            <h3 className="absolute top-[454px] left-3 px-2 mb-0 text-white bg-black z-10 rounded-md">Role</h3>
            <Form.Item
              name="role"
              rules={[
                {
